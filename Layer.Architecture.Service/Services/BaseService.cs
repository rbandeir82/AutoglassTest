...
namespace AutoglassTest.Service.Services
{
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        public IEnumerable<TOutputModel> GetPaged<TOutputModel>(int pagina, int ItensPorPagina) where TOutputModel : class
        {
            var entities = _baseRepository.SelectPaged(pagina, ItensPorPagina);
